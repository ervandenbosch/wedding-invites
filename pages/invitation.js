        ...
        <div className="flex flex-row bg-white pb-10  md:flex-wrap">
          <div className="flex w-full flex-col border-black bg-white pb-10">
            ...
            <div className="mx-8 pt-6 text-center">
              We are happy to also welcome your plus ones.
            </div>
            <h2
            ...
            <div className="mx-8 p-4 text-center">
              ...
              <br />
              As we eagerly anticipate our wedding day, we find ourselves faced
              with the challenging task of managing limited spaces for
              accommodations. Regrettably, due to these constraints, we are
              unable to provide lodging for all our cherished guests. Please
              know that this decision was not made lightly, and we sincerely
              appreciate your understanding and flexibility in this matter. We
              look forward to sharing this beautiful day with you, and we are
              grateful for your understanding as we navigate these logistical
              challenges.
