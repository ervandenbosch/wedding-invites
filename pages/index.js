                ...
                <div className="flex flex-row bg-white pb-10  md:flex-wrap">
                    <div className="flex w-full flex-col border-black bg-white pb-10 lg2:mx-48 sm:mx-2">
                        ...
                        <div className="p-6 text-justify">
                            Welcome to our wedding celebration! This moment is not just about us, uniting as a couple,
                            but also a heartfelt tribute to the incredible friends and family who've shaped us into the
                            individuals we are today.
                            <br /> <br /> That's why this celebration is so meaningful to us - it's a rare opportunity
                            to gather with those who have been instrumental in our journey and to create lasting
                            memories together. We can't wait to share this joyous occasion with you.
                        </div>

                        <div class="sm:row mt-4 flex justify-center lg2:flex-row sm:flex-col">
                            <div class="lg2:mr-8">
                                <h3 className="mt-6 text-center font-notoreg text-2xl font-bold text-black ">
                                    Where?{' '}
                                </h3>
                  ...
                  group-focus:duration-1000"
                                    >
                                        ...
                                        <ul className="ml-4 list-disc">
                                            <li>
                                                Friday guests: arrive after 5pm. <br />
                                                Saturday guests: Arrive between 12:30-14:00.
                                            </li>
                  ...
                  group-focus:duration-1000"
                                    >
                                        <ul className="ml-4 list-disc">
                                            ...
                                            <li>
                                                Please arrive to the wedding venue <b>first</b> and leave your things in
                                                the car. <br />
                                                If you’ll need to dress or touch up, you can do so on the premises of
                                                the venue.
                                            </li>
                                            <li>
                                                After the ceremony, there will be a cocktail hour between 17:00-19:00.{' '}
                                                <br />
                                                You’ll be able to use this time to get to your hotel (only 7 minutes by
                                                car) and back before dinner starts! 😊
                                            </li>
                                            <br />
                            ...
                            <div className="">
                                <div class="m-5 sm:mx-2">
                                    ...
                                    <div className="text-justify">
                                        ...
                                        <br /> Our favourite colour is blue, therefore, we’d love to incorporate it into
                                        our wedding dress code to add little extra touch to our celebration. We invite
                                        you to join us in a vibrant display of colours by incorporating shades of the
                                        below displayed colours into your attire. Whether it's a splash of these hues or
                                        a full ensemble, your creativity is welcomed. <br />
                                        <br />
                                        While we suggest these colours, feel free to choose different shades that
                                        resonate with you, ensuring you feel comfortable and fabulous.{' '}
                                        <img
                                    ...
                                    <div className="text-justify">
                                        ...
                                        have you share in our special day. If you wish to celebrate with a gesture, we
                                        would be grateful for a<b> monetary gift.</b> <br />
                                        <br />
                                        Your monetary contributions will go towards a special fund helping us say
                                        goodbye to our trusty, but rather rusty, car and welcome new adventures with a
                                        new set of wheels. <br />
                                        <br />
                                        Alternatively, we will be grateful for any gift or a an experience that comes
                                        from your heart.
                                    </div>
                                    <h2
                                            ...
                                            >
                                                ...
                                                <ul className="ml-4 list-disc">
                                                    ...
                                                    <li>
                                                        ...
                                                        10am. We’ll serve “Pho”, a traditional Vietnamese noodle soup.
                                                        For those who don’t want to eat Pho, there will be also some
                                                        yoghurts, toast breads & hams and cheeses, milk with cereals
                                                        available too.
                                                    </li>
                                                </ul>
                                            </div>
                                            ...
                                            >
                                                ...
                                                <ul className="ml-4 list-disc">
                                                    ...
                                                    <li>
                                                        ...
                                                        . Everyone will have the opportunity to showcase their dance
                                                        moves! If you're feeling shy, no worries. You can stand in the
                                                        front row and cheer for the dancers 👯 If you're looking for
                                                        some inspiration for your dance moves, check out{' '}
                                                        <a
                                                            class="underline"
                                                        ...
                                                        from the original soul-train dance. can serve as your
                                                        inspiration.
                                                    </li>
                                                    <li>
                                                        <b>Your favorite food and/or drinks to share (optional):</b>{' '}
                                                        it’s often said “Love goes through the stomach”, and so if you
                                                        have some food or a drink that makes you happy, feel free to
                                                        bring a bit along with you to share. Just let us know in advance
                  ...
                  group-focus:opacity-100 group-focus:duration-1000"
                                            >
                                                ...
                                                help us with keeping the venue clean. If you’d like to offer a helping
                                                hand with some extra little things, let us know and we’ll add you to our
                                                task force 💪
                                            </div>
                                        </div>
                                    </div>
                  ...
                  group-focus:opacity-100 group-focus:duration-1000"
                                            >
                                                ...
                                                us, contact our wedding coordinator Maude via Whatsapp on +33 6 10 53 42
                                                64. She’ll do her best to incorporate into our program 👿
                                            </div>
                                        </div>
                                    </div>
