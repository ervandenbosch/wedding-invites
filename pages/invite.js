            ...
            <div className="flex flex-row bg-white pb-10  md:flex-wrap">
                <div className="flex w-full flex-col border-black bg-white pb-10">
                    ...
                    <div className="mx-8 p-6 text-center">
                        Welcome to our wedding celebration! This moment is not just about uniting as a couple, but also
                        a heartfelt tribute to the incredible friends and family who've shaped us into the individuals
                        we are today. That's why this celebration is so meaningful to us—it's a rare opportunity to
                    ...
                    <div className="mx-8 pt-6 text-center">
                        For those who got invited alone, we are happy to also welcome your plus ones. However, in that
                    ...
                    <div className="mx-6 p-4 text-center">
                        ...
                        <div class="m-5 mt-8 space-y-2 sm:mx-2">
                            ...
                            >
                                ...
                                <div
                                    class="invisible h-auto max-h-0 items-center text-left opacity-0 transition-all group-focus:visible group-focus:mx-6 
                  group-focus:my-2  group-focus:max-h-full group-focus:opacity-100
